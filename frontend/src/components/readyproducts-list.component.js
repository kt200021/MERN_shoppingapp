...
export default class ProductsListready extends Component {
                        ...
                        this.state.products.map((currentProduct, i) => {
                            return (
                                <tr>
                                    ...
                                    <td> <button type="button" onClick={() => this.changestatus(currentProduct.username,currentProduct.productname)}>DISPATCH
              </button></td>
                                </tr>
                            )
                        })
